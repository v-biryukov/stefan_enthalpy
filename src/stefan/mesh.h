...
public:
    ...
    Mesh(std::array<int, Dims> nums, std::array<double, Dims> lengths, const std::vector<MaterialInfo>& material_infos, const std::vector<int>& material_indexes_)
        : nums_(nums), lengths_(lengths), steps_(steps_), material_infos_(material_infos), material_indexes_(material_indexes_)
    {
